...
int playSmithy(struct gameState *state, int handPos){
	...
	int currentPlayer = whoseTurn(state);
	int i;
	//int size = 4; //bug introduced changed int size = 3 to int size = 4			// Assignment 5: BUG # 2
	int size = 3;
	
    //+3 Cards
    //for (i = 0; i < size; i--) //introducing bug, changing i++ to i--				// Assignment 5: BUG # 1
	for (i = 0; i < size; i++)
	{
	  drawCard(currentPlayer, state);
	}
...
int playAdventurer (struct gameState *state, int handPos)
 ...
 //int drawntreasure = 1; // bug introduced: changed drawntreasure = 0 to drawntreasure = 1			// Assignment 5: BUG #5
 int drawntreasure = 0;
 int currentPlayer = whoseTurn(state);
 int cardDrawn;
...
{							 
	...
	if (cardDrawn == copper || cardDrawn == silver || cardDrawn == gold) 
		//ut3drawntreasure--drawntreasure--; //intorducing bug: changing drawntreasure++ to drawntreasure--			// Assignment 5:  BUG #4
		drawntreasure++;
	else
	{
...
int playCouncilRoom(struct gameState *state, int handPos)
{
    ...
    //for (i = 1; i < 4; i++) // bug introduced: changing i = 0 to i = 1						// Assignment 5:  BUG  #3
	for (i = 0; i < 4; i++)
	{
	  drawCard(currentPlayer, state);
	}

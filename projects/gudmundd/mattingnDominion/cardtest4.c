...
int main (int argc, char** argv) {
	...
	for (game_state_pass = 1; game_state_pass <= num_game_state_tests; game_state_pass++)
	{
		...
		//cardEffect(village, 0, 0, 0, &G, G.hand[current_player][G.handCount[current_player]-1], 0);		// REQUIRED CHANGE for Assignment 5
		playVillage(&G, G.hand[current_player][G.handCount[current_player]-1]);						    // REQUIRED CHANGE for Assignment 5
